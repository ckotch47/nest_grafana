...
export class ApiMetricsMiddleware implements NestMiddleware {
    constructor(
        ...
        @InjectMetric('http_request_size_bytes') public requestSizeHistogram: Histogram<string>,
        @InjectMetric('http_response_size_bytes') public responseSizeHistogram: Histogram<string>,
        @InjectMetric('http_all_request_total') public allRequestTotal: Counter<string>,
        @InjectMetric('http_all_success_total') public allSuccessTotal: Counter<string>,
        @InjectMetric('http_all_errors_total') public allErrorsTotal: Counter<string>,
        @InjectMetric('http_all_client_error_total') public allClientErrorTotal: Counter<string>,
        @InjectMetric('http_all_server_error_total') public allServerErrorTotal: Counter<string>,
    ...
    private handleResponse(req: Request, res: Response) {
        ...
        this.requestTotal.labels(req.method, route, res.statusCode.toString()).inc();
